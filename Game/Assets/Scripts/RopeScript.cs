...
public class RopeScript : MonoBehaviour
{
    ...
    */
    ...
    private void UpdateStartTargetPositions()
    {
    ...
    private void BuildRope()
    {
        ...
        BuildRope(_target, _isMovableHit);
    }

    public void BuildRope(Transform target, bool isMovableHit)
    {
        if (!rope && target != null)
        {
            line = gameObject.GetComponent<LineRenderer>();
            _target = target;
            _isMovableHit = isMovableHit;
